...
public class SysProperties {
    ...
    public static String getProperty(String proper) {
        return getInstance().getProperty(proper);
    }

    public static String getPayUAuth() {
        return SysProperties.getInstance().getProperty("PAYUMONEY_AUTH");
    }

    public static String getImagesPath() {
        return SysProperties.getInstance().getProperty("IMAGES_FOLDER_PATH");
    }
