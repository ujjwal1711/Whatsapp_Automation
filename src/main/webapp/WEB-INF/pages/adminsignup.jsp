...
<script>
    ...
    function fun(){ var username,password,email; username=$("#username").val(); password=$("#password").val(); email=$("#email").val(); var obj={"name":username,"password":password,"email":email}; console.log(obj); $.ajax({ type: "POST", url: "/admin/signup", data: JSON.stringify(obj), contentType: 'application/json', success: function (response) { }, error: function (data) { } })}
</script>
<div id="container-register">
    ...
    <form>
        ...
        <input type="button" onclick="fun()" value="Register" />
    </form>
