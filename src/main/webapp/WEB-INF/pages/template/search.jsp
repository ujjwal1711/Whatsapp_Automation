...
<html dir="ltr" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- ==== Google Font ==== -->
    <link rel="stylesheet" href="/static/template/404_files/css">

    <!-- ==== Plugins Bundle ==== -->
    <link rel="stylesheet" href="/static/template/404_files/plugins.min.css">

    <!-- ==== Main Stylesheet ==== -->
    <link rel="stylesheet" href="/static/template/404_files/style.css">

    <!-- ==== Responsive Stylesheet ==== -->
    <link rel="stylesheet" href="/static/template/404_files/responsive-style.css">

    <!-- ==== Color Scheme Stylesheet ==== -->
    <link rel="stylesheet" href="/static/template/404_files/color-1.css" id="changeColorScheme">

    <!-- ==== Custom Stylesheet ==== -->
    <link rel="stylesheet" href="/static/template/404_files/custom.css">
...
<body>
    ...
    <div class="wrapper">
        <!-- 404 Section Start -->
        <div class="f0f--section" style="min-height: 642px;">
            <div class="f0f--bg hidden-xs">
                <div class="f0f--bg-inner bg--img" data-rjs="2" style="background-image: url(&quot;/static/template/images/light-bg.png&quot;);"></div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <div class="f0f--content text-white text-center pt--80 pb--80">
                                    <div style="margin-bottom:30px" class="caption fs--18 fw--700 text-uppercase">
                                        <p>Become a Bahubali</p>
                                    </div>
                                    ...
                                    <div class="search--widget" data-form="validate">
                                        <form action="/filter" novalidate="novalidate">
                                    ...
                                    <div class="desc fs--18 fw--500">
                                        <p>Search about post you want to share.</p>
                                    </div>

                                    <div class="buttons">
                                        <a href="/filter" class="btn btn-white">Show Trending Posts<i class="fa fa-home"></i></a>

                                        <a href="/socifly/html/404.html#" class="btn btn-white" onclick="window.history.go(-1); return false;">Return Back<i class="fa fa-reply"></i></a>
                                    </div>

                                    <div class="social pt--60">
                                        <ul class="nav">
                                            <li><a href="/socifly/html/404.html#"><span class="fa fa-facebook"></span></a></li>
                                            <li><a href="/socifly/html/404.html#"><span class="fa fa-twitter"></span></a></li>
                                            <li><a href="/socifly/html/404.html#"><span class="fa fa-google-plus"></span></a></li>
                                            <li><a href="/socifly/html/404.html#"><span class="fa fa-linkedin"></span></a></li>
                                            <li><a href="/socifly/html/404.html#"><span class="fa fa-rss"></span></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
